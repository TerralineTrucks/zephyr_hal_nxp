...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Qspi_Ip_Init_PBcfg.h header file are of the same
 * vendor */
...
/* Check if current file and Qspi_Ip_Init_PBcfg.h header file are of the same
 * Autosar version */
#if ((QSPI_IP_AR_RELEASE_MAJOR_VERSION_CFG !=         \
      QSPI_IP_INIT_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (QSPI_IP_AR_RELEASE_MINOR_VERSION_CFG !=         \
      QSPI_IP_INIT_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (QSPI_IP_AR_RELEASE_REVISION_VERSION_CFG !=      \
      QSPI_IP_INIT_PBCFG_AR_RELEASE_REVISION_VERSION))
#error \
    "AutoSar Version Numbers of Qspi_Ip_Cfg.h and Qspi_Ip_Init_PBcfg.h are different"
#endif
/* Check if current file and Qspi_Ip_Init_PBcfg.h header file are of the same
 * software version */
...
#error \
    "Software Version Numbers of Qspi_Ip_Cfg.h and Qspi_Ip_Init_PBcfg.h are different"
#endif
...
/* Pre-processor switch to enable/disable development error detection for QSPI
 * Ip API */
