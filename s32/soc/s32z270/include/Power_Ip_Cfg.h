...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Power_Ip_Cfg.h file and Power_Ip_Init_PBcfg.h file are of the same
 * vendor */
...
/* Check if Power_Ip_Cfg.h file and Power_Ip_Init_PBcfg.h file are of the same
 * Autosar version */
#if ((POWER_IP_CFG_AR_RELEASE_MAJOR_VERSION !=    \
      POWER_IP_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_CFG_AR_RELEASE_MINOR_VERSION !=    \
      POWER_IP_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (POWER_IP_CFG_AR_RELEASE_REVISION_VERSION != \
      POWER_IP_PBCFG_AR_RELEASE_REVISION_VERSION))
#error \
    "AutoSar Version Numbers of Power_Ip_Cfg.h and Power_Ip_Init_PBcfg.h are different"
#endif
...
#error \
    "Software Version Numbers of Power_Ip_Cfg.h and Power_Ip_Init_PBcfg.h are different"
#endif
 ...
 *               If this parameter has been configured to 'TRUE' the Power can
 * be executed from both supervisor and user mode.
 */
#define POWER_IP_ENABLE_USER_MODE_SUPPORT (STD_OFF)

/** Check the driver user mode is enabled only when the
 * MCAL_ENABLE_USER_MODE_SUPPORT is enabled */
