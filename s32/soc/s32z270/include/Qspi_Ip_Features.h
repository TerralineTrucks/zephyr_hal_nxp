...
/*! @brief First address of the serial flash device on the AHB bus for QuadSPI
 * instances */
...
/*! @brief Supports DQS_FA_SEL/DQS_FB_SEL field in MCR register for DQS
 * selection */
...
/*! @brief The maximum size of manufacturer & device ID that flash memories can
 * have */
