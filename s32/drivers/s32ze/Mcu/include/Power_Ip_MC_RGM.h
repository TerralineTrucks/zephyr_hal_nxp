...
#define POWER_IP_MC_RGM_SW_MAJOR_VERSION                1
...
#define  Call_Power_Ip_MC_RGM_ConfigureCore(CoreConfigPtr, DomainIndex) \
    OsIf_Trusted_Call2params(Power_Ip_MC_RGM_ConfigureCore,(CoreConfigPtr), (DomainIndex))
#define  Call_Power_Ip_MC_RGM_ReleaseDomainReset(DomainIdx) \
    OsIf_Trusted_Call1param(Power_Ip_MC_RGM_ReleaseDomainReset,(DomainIdx))
...
#define  Call_Power_Ip_MC_RGM_AssertDomainReset(DomainIndex) \
    OsIf_Trusted_Call1param(Power_Ip_MC_RGM_AssertDomainReset,(DomainIndex))
#define  Call_Power_Ip_MC_RGM_ConfigureCOFB(CofbConfigPtr, DomainIndex) \
    OsIf_Trusted_Call2params(Power_Ip_MC_RGM_ConfigureCOFB,(CofbConfigPtr), (DomainIndex))

  #else /* (STD_OFF == POWER_IP_ENABLE_USER_MODE_SUPPORT) */

#define  Call_Power_Ip_MC_RGM_ConfigureCore(CoreConfigPtr, DomainIndex) \
    Power_Ip_MC_RGM_ConfigureCore(CoreConfigPtr, DomainIndex)
#define  Call_Power_Ip_MC_RGM_ReleaseDomainReset(DomainIdx) \
    Power_Ip_MC_RGM_ReleaseDomainReset(DomainIdx)
#define  Call_Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr) \
    Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr)
#define  Call_Power_Ip_MC_RGM_AssertDomainReset(DomainIndex) \
    Power_Ip_MC_RGM_AssertDomainReset((uint8)DomainIndex)
#define  Call_Power_Ip_MC_RGM_ConfigureCOFB(CofbConfigPtr, DomainIndex) \
    Power_Ip_MC_RGM_ConfigureCOFB(CofbConfigPtr, DomainIndex)
