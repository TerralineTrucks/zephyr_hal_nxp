...
#if ((POWER_IP_TYPES_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_TYPES_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION))
    #error "AutoSar Version Numbers of Power_Ip_Types.h and Mcal.h are different"
#endif
#endif
...
/* Check if Power_Ip_Types.h file and Power_Ip_GPR_Types.h file have same versions */
#if (POWER_IP_TYPES_VENDOR_ID  != POWER_IP_GPR_TYPES_VENDOR_ID)
    #error "Power_Ip_Types.h and Power_Ip_GPR_Types.h have different vendor IDs"
#endif

/* Check if Power_Ip_Types.h file and Power_Ip_GPR_Types.h file are of the same Autosar version */
#if ((POWER_IP_TYPES_AR_RELEASE_MAJOR_VERSION    != POWER_IP_GPR_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_TYPES_AR_RELEASE_MINOR_VERSION    != POWER_IP_GPR_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (POWER_IP_TYPES_AR_RELEASE_REVISION_VERSION != POWER_IP_GPR_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Power_Ip_Types.h and Power_Ip_GPR_Types.h are different"
#endif

/* Check if Power_Ip_Types.h file and Power_Ip_GPR_Types.h file are of the same Software version */
#if ((POWER_IP_TYPES_SW_MAJOR_VERSION != POWER_IP_GPR_TYPES_SW_MAJOR_VERSION) || \
     (POWER_IP_TYPES_SW_MINOR_VERSION != POWER_IP_GPR_TYPES_SW_MINOR_VERSION) || \
     (POWER_IP_TYPES_SW_PATCH_VERSION != POWER_IP_GPR_TYPES_SW_PATCH_VERSION))
    #error "Software Version Numbers of Power_Ip_Types.h and Power_Ip_GPR_Types.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
typedef struct
{
    ...
    /** @brief Indicates Deep sleep configuration */
    boolean DeepSleep;
    ...
    /** @brief GPR IP settings. */
    const Power_Ip_GPR_ConfigType * GprConfigPtr;
